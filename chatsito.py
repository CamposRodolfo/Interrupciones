...
BitacoraInterrupciones = PrettyTable()
BitacoraInterrupciones.field_names = ["Tiempo Real", "Área de Dispositivo", "Interrupción Aceptada", "Rango de Tiempo en Dispositivo", "Tiempo Faltante"]
...
def CalcularDiagramaControlProcesos(T0, Tf):
    ...
    DiagramaControlProcesos.field_names = ["Tiempo", "Programa"] + dispositivos
    for tiempo in range(T0, Tf + 1):
        ...
        DiagramaControlProcesos.add_row(fila)
    ...
    for tiempo in range(T0, Tf + 1):
        for row in TablaDatos:
            if row[0] == tiempo:
                dispositivo = row[1]
                duracion = row[2]
                BitacoraInterrupciones.add_row([tiempo, dispositivo, "Sí", f"{tiempo}-{tiempo + duracion}", duracion])
...
print("+------------------------------+")
print(DiagramaControlProcesos)

print("+------------------------------+")
print("|     Bitácora de Interrupciones     |")
print("+------------------------------+")
print(BitacoraInterrupciones)
